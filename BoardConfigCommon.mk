...
BOARD_USERDATAIMAGE_PARTITION_SIZE := 50490624512
...
BOARD_ASUS_DYNAMIC_PARTITIONS_PARTITION_LIST := system vendor product system_ext odm
...
$(foreach p, $(call to-upper, $(BOARD_ASUS_DYNAMIC_PARTITIONS_PARTITION_LIST)), \
    $(eval BOARD_$(p)IMAGE_FILE_SYSTEM_TYPE := ext4) \
    $(eval TARGET_COPY_OUT_$(p) := $(call to-lower, $(p))))

BOARD_SYSTEMIMAGE_PARTITION_RESERVED_SIZE := 204857600 # 200 MB
BOARD_SYSTEM_EXTIMAGE_PARTITION_RESERVED_SIZE := 204857600 # 200 MB
BOARD_VENDORIMAGE_PARTITION_RESERVED_SIZE := 204857600 # 200 MB
BOARD_ODMIMAGE_PARTITION_RESERVED_SIZE := 204857600 # 200 MB
BOARD_PRODUCTIMAGE_PARTITION_RESERVED_SIZE := 204857600 # 200 MB
